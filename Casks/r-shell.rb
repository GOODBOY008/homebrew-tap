...
cask "r-shell" do
  ...
  on_arm do
    ...
    url "https://github.com/GOODBOY008/r-shell/releases/download/v1.4.0/r-shell_#{version}_aarch64.dmg"
  end
  
  on_intel do
    sha256 "ba876ece60b005f854a1c9f5b0618ac63491ea0a7fb19c6c823f88bbdbac32e6"
    url "https://github.com/GOODBOY008/r-shell/releases/download/v1.4.0/r-shell_#{version}_x64.dmg"
  end
